...
public class DispatcherServlet extends HttpServlet {
	...
	private void process(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			ModelAndView viewName = ctrl.handleRequest(request, response);
		} catch (Exception e) {
	...
	//	if (!viewName.getViewName().contains(".do")) { 
	// =viewResolver.getView(viewName.getViewName());//"getboardList" -> ./getboardList.jsp
	//	} else {
